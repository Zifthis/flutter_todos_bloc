...
///The FilterButton needs to respond to state changes in
///the FilteredTodosBloc so it uses BlocProvider to
///access the FilteredTodosBloc from the BuildContext.
///It then uses BlocBuilder to re-render whenever
///the FilteredTodosBloc changes state.
